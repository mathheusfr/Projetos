    ...
    do {
        ...
        switch (op) {
            ...
            case 1: {
                ...
                // Utilize qsort para ordenar se necessário
                break;
            }
            ...
            case 3: {
                system("cls");  
                printf("Busca por cidade e mês com bsearch\n");
            ...
            case 4: {
                system("cls");  
                printf("Busca por cidade e mês com tabela hash\n");
                // Implemente aqui a busca por cidade e mês com tabela hash
                break;
            }
            ...
            case 5: {
                ...
                // Implemente aqui a função para mostrar dados da memória
                break;
            }
