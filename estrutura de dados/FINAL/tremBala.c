...
void buscarTodosComTabelaHash(HashTable *tabelaHash) {
    ...
    printf("Busca com mais comparacoes (%d): %s\n", comparacoesMax, cidadeMaisComparacoes);
}
    ...
    do {
        ...
        switch (op) {
            ...
            case 1: {
                ...
                // Variável para contar o número total de comparações
                int comparacoesTotais = 0;
                
                // Percorrer todos os registros ordenados e exibir cada cidade apenas uma vez
                int i;
                for (i = 0; i < numRegistros; i++) {
                    ...
                    if (registroEncontradoBSearch != NULL) {
                        ...
                        // Marcar o registro como já exibido para evitar repetições
                        strcpy(registros[i]->nome_cidade, ""); // Limpar o nome da cidade
                    }
                }
